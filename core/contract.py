...
@jit(float64[:,:](float64[:,:],float64[:,:],float64[:,:]),nopython=True,parallel=True,fastmath=False,cache=True,nogil=True)
...
@jit(float64[:,:,:,:](float64[:,:,:,:],float64[:,:]),nopython=True,parallel=True,fastmath=False,cache=True,nogil=True)
def con_jit42(A,B):
